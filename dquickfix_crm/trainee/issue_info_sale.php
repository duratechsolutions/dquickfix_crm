...
<?php require_once('Connections/connection.php'); $issueId = date('Ymdsim'); ?>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $id = mysql_insert_id();
  $insertSQL = sprintf("INSERT INTO history_issue_info (info_id, subject, notes, status, customer_id, no_sale, created_by)	 VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="submit" name="submit" id="submit" value="Save" />&nbsp;&nbsp;<span id="save_button"></span></td>
    </tr>
  </table>
  ...
  <input type="hidden" name="computer_id" value="<?php echo $_GET["computer_id"];?>" />
